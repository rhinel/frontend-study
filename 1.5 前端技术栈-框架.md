...
[深度解读当代前端架构进化史，下一个趋势在哪？](https://mp.weixin.qq.com/s/vEO4r3-pSROgBzOQjzjV3A)
...
* [Vue技能进阶：使用设计模式写出优雅的前端代码](https://mp.weixin.qq.com/s/DmwRQE7n0EWOraQRWs8nCg)
...
* [如何手撸一个Vue 3.0异步函数API？](https://mp.weixin.qq.com/s/_LnErLI4hnOlwhiCQ76XiQ)
